...
export const metadata = {
    title: 'Tin tức Serie A Mới Nhất | Bóng Đá Ý',
    description: 'Tin tức bóng đá Ý - Serie A mới nhất hôm nay. Cập nhật kết quả, lịch thi đấu, bảng xếp hạng và thông tin về Juventus, AC Milan, Inter Milan.',
};
        ...
        <div style={{ background: '#f4f4f4', minHeight: '100vh' }}>
            ...
            <main style={{ maxWidth: '1200px', margin: '2rem auto', padding: '0 1rem', background: '#fff', borderRadius: '8px', border: '1px solid #eee' }}>
                ...
                <div style={{ padding: '0 1.5rem 1.5rem', display: 'grid', gap: '2rem' }}>
                    {articles.length === 0 ? (
                        <p style={{ color: '#666' }}>Hệ thống đang cập nhật tin tức Serie A...</p>
                    ) : (
                        <>
