...
export const metadata = {
    title: 'Tin tức La Liga Mới Nhất | Kết Quả & BXH Tây Ban Nha',
    description: 'Tin tức bóng đá Tây Ban Nha - La Liga mới nhất. Cập nhật kết quả, lịch thi đấu, bảng xếp hạng và tin tức về Real Madrid, Barca, Atletico.',
};
        ...
        <div style={{ background: '#f4f4f4', minHeight: '100vh' }}>
            ...
            <main style={{ maxWidth: '1200px', margin: '2rem auto', padding: '0 1rem', background: '#fff', borderRadius: '8px', border: '1px solid #eee' }}>
                ...
                <div style={{ padding: '0 1.5rem 1.5rem', display: 'grid', gap: '2rem' }}>
                    {articles.length === 0 ? (
                        <p style={{ color: '#666' }}>Hệ thống đang cập nhật tin tức La Liga...</p>
                    ) : (
                        <>
