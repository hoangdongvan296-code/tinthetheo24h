...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return {
        title: `Tin tức cầu thủ ${name} mới nhất | Tin Thể Thao 24h`,
        description: `Cập nhật tin tức, sự nghiệp, phong độ và thông tin mới nhất về siêu sao bóng đá ${name} liên tục 24/7.`,
    };
}
                        ...
                        <div style={{ padding: '1.5rem', display: 'grid', gap: '2rem' }}>
                            {articles.length === 0 ? (
                                <p style={{ color: '#666', textAlign: 'center', padding: '2rem' }}>
                                    Hệ thống đang cập nhật thêm tin tức về cầu thủ {name}...
                                </p>
                            ) : (
                                <>
