...
export const metadata = {
    title: 'Tin tức Bundesliga Mới Nhất | Bóng Đá Đức',
    description: 'Cập nhật tin tức giải vô địch quốc gia Đức - Bundesliga mới nhất. Tin tức về Bayern Munich, Dortmund, kết quả và BXH bóng đá Đức.',
};
...
export default async function BundesligaPage({
    ...
    const limit = 20;
    const categoryQuery = 'Bundesliga';
        ...
        <div style={{ background: '#f4f4f4', minHeight: '100vh' }}>
            ...
            <main style={{ maxWidth: '1200px', margin: '2rem auto', padding: '0 1rem', background: '#fff', borderRadius: '8px', border: '1px solid #eee' }}>
                ...
                <div style={{ padding: '0 1.5rem 1.5rem', display: 'grid', gap: '2rem' }}>
                    {articles.length === 0 ? (
                        <p style={{ color: '#666' }}>Hệ thống đang cập nhật tin tức Bundesliga...</p>
                    ) : (
                        <>
